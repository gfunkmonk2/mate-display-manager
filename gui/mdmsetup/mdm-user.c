                  ...
                  MdmUser *user2)
{
        ...
        g_return_val_if_fail (user1 == NULL || MDM_IS_USER (user1), 0);
        g_return_val_if_fail (user2 == NULL || MDM_IS_USER (user2), 0);
...
static GdkPixbuf *
render_icon_from_home (MdmUser *user,
                       int      icon_size)
{
        GdkPixbuf  *retval;
        char       *path;
...
GdkPixbuf *
mdm_user_render_icon (MdmUser   *user,
                      gint       icon_size)
{
        GdkPixbuf    *pixbuf;
        GdkPixbuf    *framed;
