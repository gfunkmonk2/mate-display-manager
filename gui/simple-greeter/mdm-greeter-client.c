...
static void
on_select_user (MdmGreeterClient *client,
                DBusMessage      *message)
{
        g_debug("MdmGreeterClient: SelectUser");
...
mdm_greeter_client_class_init (MdmGreeterClientClass *klass)
{
        ...
        mdm_greeter_client_signals[SELECT_USER] =
                g_signal_new ("select-user",
                              G_OBJECT_CLASS_TYPE (object_class),
                              G_SIGNAL_RUN_FIRST,
                              G_STRUCT_OFFSET (MdmGreeterClientClass, select_user),
                              NULL,
                              NULL,
                              g_cclosure_marshal_VOID__STRING,
                              G_TYPE_NONE,
