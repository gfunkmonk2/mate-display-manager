...
void
mdm_session_settings_set_langlist_name (MdmSessionSettings *settings,
...
void
mdm_session_settings_set_lcmess_name (MdmSessionSettings *settings,
...
void
mdm_session_settings_set_is_failsafe (MdmSessionSettings *settings,
                                      gboolean            failsafe)
{
        g_return_if_fail (MDM_IS_SESSION_SETTINGS (settings));
...
char *
mdm_session_settings_get_langlist_name (MdmSessionSettings *settings)
{
        g_return_val_if_fail (MDM_IS_SESSION_SETTINGS (settings), NULL);
...
char *
mdm_session_settings_get_lcmess_name (MdmSessionSettings *settings)
{
        g_return_val_if_fail (MDM_IS_SESSION_SETTINGS (settings), NULL);
...
gboolean
mdm_session_settings_get_is_failsafe (MdmSessionSettings *settings)
{
                                  ...
                                  GParamSpec   *pspec)
{
        ...
        switch (prop_id) {
                ...
                case PROP_LANGLIST_NAME:
                        mdm_session_settings_set_langlist_name (settings, g_value_get_string (value));
                break;

                case PROP_LCMESS_NAME:
                        mdm_session_settings_set_lcmess_name (settings, g_value_get_string (value));
                break;

                case PROP_IS_FAILSAFE:
                        mdm_session_settings_set_is_failsafe (settings, g_value_get_boolean (value));
                break;
                           ...
                           GError             **error)
{
        ...
        if (langlist_name != NULL) {
                mdm_session_settings_set_langlist_name (settings, langlist_name);
        ...
        if (lcmess_name != NULL) {
                mdm_session_settings_set_lcmess_name (settings, lcmess_name);
                g_free (lcmess_name);
        } else if (g_error_matches (load_error, G_KEY_FILE_ERROR, G_KEY_FILE_ERROR_KEY_NOT_FOUND)) {
                g_error_free (load_error);
                load_error = NULL;
        ...
        mdm_session_settings_set_is_failsafe (settings, FALSE);
