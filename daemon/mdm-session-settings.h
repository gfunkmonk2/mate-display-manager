...
char               *mdm_session_settings_get_langlist_name  (MdmSessionSettings *settings);
char               *mdm_session_settings_get_lcmess_name    (MdmSessionSettings *settings);
gboolean            mdm_session_settings_get_is_failsafe    (MdmSessionSettings *settings);
...
void                mdm_session_settings_set_langlist_name  (MdmSessionSettings *settings,
                                                             const char         *langlist_name);
void                mdm_session_settings_set_lcmess_name    (MdmSessionSettings *settings,
                                                             const char         *lcmess_name);
void                mdm_session_settings_set_is_failsafe    (MdmSessionSettings *settings,
