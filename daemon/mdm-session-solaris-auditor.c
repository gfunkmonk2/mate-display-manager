...
struct _MdmSessionSolarisAuditorPrivate
{
...
static void mdm_session_solaris_auditor_finalize (GObject *object);

G_DEFINE_TYPE (MdmSessionSolarisAuditor, mdm_session_solaris_auditor, MDM_TYPE_SESSION_AUDITOR)

static void
mdm_session_solaris_auditor_report_password_changed (MdmSessionAuditor *auditor)
{
...
static void
mdm_session_solaris_auditor_report_password_change_failure (MdmSessionAuditor *auditor)
{
        MdmSessionSolarisAuditor *solaris_auditor;
...
static void
mdm_session_solaris_auditor_report_user_accredited (MdmSessionAuditor *auditor)
{
        MdmSessionSolarisAuditor *solaris_auditor;
...
static void
mdm_session_solaris_auditor_class_init (MdmSessionSolarisAuditorClass *klass)
{
        ...
        object_class->finalize = mdm_session_solaris_auditor_finalize;

        auditor_class->report_password_changed = mdm_session_solaris_auditor_report_password_changed;
        auditor_class->report_password_change_failure = mdm_session_solaris_auditor_report_password_change_failure;
        auditor_class->report_user_accredited = mdm_session_solaris_auditor_report_user_accredited;
        auditor_class->report_login = mdm_session_solaris_auditor_report_login;
        auditor_class->report_login_failure = mdm_session_solaris_auditor_report_login_failure;
        auditor_class->report_logout = mdm_session_solaris_auditor_report_logout;

        g_type_class_add_private (auditor_class, sizeof (MdmSessionSolarisAuditorPrivate));
}

static void
on_username_set (MdmSessionSolarisAuditor *auditor)
{
        char          *username;
...
static void
mdm_session_solaris_auditor_init (MdmSessionSolarisAuditor *auditor)
{
        auditor->priv = G_TYPE_INSTANCE_GET_PRIVATE (auditor,
                                                     MDM_TYPE_SESSION_SOLARIS_AUDITOR,
                                                     MdmSessionSolarisAuditorPrivate);
...
static void
mdm_session_solaris_auditor_finalize (GObject *object)
{
        MdmSessionSolarisAuditor *solaris_auditor;
        GObjectClass *parent_class;

        solaris_auditor = MDM_SESSION_SOLARIS_AUDITOR (object);

        g_free (solaris_auditor->priv->username);
        solaris_auditor->priv->username = NULL;

        parent_class = G_OBJECT_CLASS (mdm_session_solaris_auditor_parent_class);
...
MdmSessionAuditor *
mdm_session_solaris_auditor_new (const char *hostname,
                                 const char *display_device)
{
        GObject *auditor;

        auditor = g_object_new (MDM_TYPE_SESSION_SOLARIS_AUDITOR,
                                "hostname", hostname,
