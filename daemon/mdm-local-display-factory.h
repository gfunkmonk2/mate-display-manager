...
gboolean                   mdm_local_display_factory_create_transient_display (MdmLocalDisplayFactory *factory,
                                                                               char                  **id,
                                                                               GError                **error);
gboolean                   mdm_local_display_factory_switch_to_user (MdmLocalDisplayFactory *factory,
                                                                     char                   *username,
                                                                     char                  **id,
                                                                     GError                **error);

gboolean                   mdm_local_display_factory_start_guest_session       (MdmLocalDisplayFactory *factory,
